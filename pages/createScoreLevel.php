...
<form id="manage_scoring" method="POST">
  <input hidden id="rubricItemID" name="rubricItemID" value="<?php echo $_REQUEST['rubricItemID']; ?>" />
  ...
  <button name="submit_score" class="orange_button button tinyButtonFix" value="create">Create New Score Level</button>
</form>
